...
func TestSendableLanMessage_MarshalBinary(t *testing.T) {
	...
	expected := []byte{0xff, 0x1f, 0x0, 0x34, 0xff, 0xff, 0xff, 0x1f, 0x1f,
...
func TestReceivableLanMessage_UnmarshalBinary(t *testing.T) {
	...
	b := []byte{0xff, 0x1f, 0x0, 0x34, 0xff, 0xff, 0xff, 0x1f, 0x1f, 0xff, 0xff,
		0xff, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x1f,
...
func TestLanHeaderFrameAddress_MarshalBinary(t *testing.T) {
	...
	expected := []byte{0x1f, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0, 0x0,
...
func TestLanHeaderFrameAddress_UnmarshalBinary(t *testing.T) {
	...
	b := []byte{0x1f, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0,
